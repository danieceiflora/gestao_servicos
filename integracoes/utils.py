...
CURATED_FIELDS = {
    ...
    'Sale': [
        ...
        ('public_token',            'Venda > Token da Página Pública (UUID puro)'),
        ('public_page_path',        'Venda > Caminho da Página Pública (venda/token/)'),
        ('public_page_url',         'Venda > Link da Página Pública (URL completa)'),
        ('billing.public_token',        'Cobrança > Token da Página de Pagamento (UUID puro)'),
        ('billing.public_page_path',    'Cobrança > Caminho da Página de Pagamento (pagar/token/)'),
        ('billing.public_page_url',     'Cobrança > Link da Página de Pagamento (URL completa)'),
    ...
    'Billing': [
        ...
        ('public_token',            'Cobrança > Token da Página de Pagamento (UUID puro)'),
        ('public_page_path',        'Cobrança > Caminho da Página de Pagamento (pagar/token/)'),
        ('public_page_url',         'Cobrança > Link da Página de Pagamento (URL completa)'),
        ('service_order.number',         'OS > Número'),
        ('service_order.public_token',    'OS > Token da Página Pública (UUID puro)'),
        ('service_order.public_page_path','OS > Caminho da Página Pública (os/token/)'),
        ('service_order.public_page_url', 'OS > Link da Página Pública (URL completa)'),
    ...
    'Installment': [
        ...
        ('discount_deadline',           'Parcela > Data Limite do Desconto'),
        ('discount_value',              'Parcela > Valor do Desconto (% ou R$ fixo, conforme a regra)'),
        ('discount_amount',             'Parcela > Valor do Desconto (R$, já calculado)'),
        ('discounted_amount',           'Parcela > Valor com Desconto (R$, já calculado)'),
        ...
        ('billing.sale.number',              'Venda > Número do Pedido'),
        ('billing.sale.get_status_display',  'Venda > Status'),
        ('billing.sale.total_amount',        'Venda > Valor Total'),
        ('billing.sale.discount',            'Venda > Desconto'),
        ('billing.sale.external_po_number',  'Venda > Nº Pedido do Cliente (PO)'),
        ('billing.sale.delivery_date',       'Venda > Prazo de Entrega'),
        ('billing.sale.created_at',          'Venda > Data da Venda'),
        ('billing.sale.notes_customer',      'Venda > Observações para o Cliente'),
