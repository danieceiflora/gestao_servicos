---
name: "Especialista Django"
description: "Use quando precisar criar ou refatorar código Django, otimizar queries do ORM, integrar HTMX/Alpine.js, configurar PWAs, ou trabalhar com mapas, geolocalização e ordens de serviço no ecossistema Python."
---
