---
name: Especialista em UI/UX
description: Use quando precisar criar ou estilizar componentes de interface, adaptar a estética Shadcn/UI para Django Templates, trabalhar com Tailwind CSS, ou melhorar a usabilidade e acessibilidade (WCAG) do frontend.
---
