...
urlpatterns = [
    ...
    path('estoque/notas-entrada/', views_stock.PurchaseInvoiceListView.as_view(), name='purchase_invoice_list'),
    path('estoque/notas-entrada/importar/', views_stock.purchase_invoice_import_preview, name='purchase_invoice_import_preview'),
    path('estoque/notas-entrada/nova/', views_stock.purchase_invoice_create, name='purchase_invoice_create'),
    path('estoque/notas-entrada/<int:pk>/', views_stock.PurchaseInvoiceDetailView.as_view(), name='purchase_invoice_detail'),
    path('estoque/notas-entrada/<int:pk>/lancar/', views_stock.purchase_invoice_launch, name='purchase_invoice_launch'),
    path('estoque/notas-entrada/<int:pk>/cancelar/', views_stock.purchase_invoice_cancel, name='purchase_invoice_cancel'),
